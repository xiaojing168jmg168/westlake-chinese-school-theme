        ...
        <div class="group">
          <div class="site-footer__col-one">
            <h1 class="school-logo-text school-logo-text--alt-color">
              <a href="<?php echo site_url() ?>">Westlake <strong>Chinese</strong> School</a>
            </h1>
    ...
    <div class="search-overlay">
     <div class="search-overlay__top">
       <div class="container">
        ...
        <input type="text" class="search-term" placeholder="What are you looking for?" id="searc-term" autocomplete="off">
